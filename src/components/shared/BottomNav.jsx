...
export default function BottomNav() {
  ...
  return (
    <nav className="bottom-nav">
      ...
      <NavLink to="/preview" className="nav-btn">
        <span className="nav-ico">
          {/* Примерить */}
          <svg width="24" height="24" viewBox="0 0 24 24">
            <circle fill="currentColor" cx="12" cy="12" r="8" />
            <path fill="#21e673" d="M8 12l2 2 4-4" stroke="#21e673" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </span>
        <span className="nav-label">Примерить</span>
      </NavLink>
      ...
      <NavLink to="/cart" className="nav-btn nav-cart-btn" style={{ position: "relative" }}>
        <span className="nav-ico" style={{ position: "relative" }}>
          ...
          {cartCount > 0 && (
            <span className="cart-badge cart-badge-red">{cartCount}</span>
          )}
        </span>
